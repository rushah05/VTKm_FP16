...
//============================================================================
#ifndef vtk_m_internal_ArrayPortalUniformPointCoordinatesFP16_h
#define vtk_m_internal_ArrayPortalUniformPointCoordinatesFP16_h
...
///
class VTKM_ALWAYS_EXPORT ArrayPortalUniformPointCoordinatesFP16
{
public:
  using ValueType = vtkm::Vec3f_16;

  VTKM_EXEC_CONT
  ArrayPortalUniformPointCoordinatesFP16()
    : Dimensions(0)
    , NumberOfValues(0)
    , Origin(0, 0, 0)
    , Spacing(1, 1, 1)
  ...
  VTKM_EXEC_CONT
  ArrayPortalUniformPointCoordinatesFP16(vtkm::Id3 dimensions, ValueType origin, ValueType spacing)
...
#endif //vtk_m_internal_ArrayPortalUniformPointCoordinatesFP16_h
