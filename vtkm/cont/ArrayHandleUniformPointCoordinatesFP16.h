...
{
  using Superclass = Storage<vtkm::Vec3f_16, StorageTagUniformPointsFP16Superclass>;

  using Superclass::Superclass;
};

template <typename Device>
struct ArrayTransfer<vtkm::Vec3f_16, vtkm::cont::StorageTagUniformPointsFP16, Device>
  : ArrayTransfer<vtkm::Vec3f_16, StorageTagUniformPointsFP16Superclass, Device>
{
  using Superclass = ArrayTransfer<vtkm::Vec3f_16, StorageTagUniformPointsFP16Superclass, Device>;
...
///
class VTKM_ALWAYS_EXPORT ArrayHandleUniformPointCoordinatesFP16
