...
public:
  ...
  VTKM_CONT vtkm::Id GetNumberOfPointsFP16() const;
  ...
  void AddCoordinateSystem(const vtkm::cont::CoordinateSystem& cs)
  {
   ...
   VTKM_CONT
  void AddCoordinateSystemFP16(const vtkm::cont::CoordinateSystemFP16& cs)
  {
    this->CoordSystemsFP16.push_back(cs);
  }
  ...
  bool HasCoordinateSystem(const std::string& name) const
  {
   ...
   VTKM_CONT
  bool HasCoordinateSystemFP16(const std::string& name) const
  {
    return this->GetCoordinateSystemIndexFP16(name) >= 0;
  }
  ...
  vtkm::cont::CoordinateSystem& GetCoordinateSystem(vtkm::Id index = 0);
   ...
   VTKM_CONT
  const vtkm::cont::CoordinateSystemFP16& GetCoordinateSystemFP16(vtkm::Id index = 0) const;

  VTKM_CONT
  vtkm::cont::CoordinateSystemFP16& GetCoordinateSystemFP16(vtkm::Id index = 0);
  ...
  VTKM_CONT
  vtkm::Id GetCoordinateSystemIndexFP16(const std::string& name) const;
  ...
  //@}
   ...
   VTKM_CONT
  const vtkm::cont::CoordinateSystemFP16& GetCoordinateSystemFP16(const std::string& name) const;

  VTKM_CONT
  vtkm::cont::CoordinateSystemFP16& GetCoordinateSystemFP16(const std::string& name);
  ...
  VTKM_CONT
  vtkm::IdComponent GetNumberOfCoordinateSystemsFP16() const
  {
    return static_cast<vtkm::IdComponent>(this->CoordSystemsFP16.size());
  }
  ...
  VTKM_CONT
  void PrintSummaryFP16(std::ostream& out) const;
...
private:
  ...
  std::vector<vtkm::cont::CoordinateSystemFP16> CoordSystemsFP16;
