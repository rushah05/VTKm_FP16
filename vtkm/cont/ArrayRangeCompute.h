...
VTK_M_ARRAY_RANGE_COMPUTE_EXPORT_T(vtkm::Float16, vtkm::cont::StorageTagBasic);
...
VTK_M_ARRAY_RANGE_COMPUTE_EXPORT_VEC(vtkm::Float16, 3, vtkm::cont::StorageTagBasic);
...
VTKM_CONT_EXPORT VTKM_CONT vtkm::cont::ArrayHandle<vtkm::Range> ArrayRangeCompute(
  const vtkm::cont::ArrayHandle<vtkm::Vec3f,  vtkm::cont::ArrayHandleUniformPointCoordinates::StorageTag>& array,
  vtkm::cont::DeviceAdapterId device = vtkm::cont::DeviceAdapterTagAny());

VTKM_CONT_EXPORT VTKM_CONT vtkm::cont::ArrayHandle<vtkm::Range> ArrayRangeCompute(
  const vtkm::cont::ArrayHandle<vtkm::Vec3f_16,  vtkm::cont::ArrayHandleUniformPointCoordinatesFP16::StorageTag>& array,
  vtkm::cont::DeviceAdapterId device = vtkm::cont::DeviceAdapterTagAny());
...
VTKM_CONT_EXPORT VTKM_CONT vtkm::cont::ArrayHandle<vtkm::Range> ArrayRangeCompute(
  const vtkm::cont::ArrayHandle<vtkm::Vec3f_16,
                                typename vtkm::cont::ArrayHandleCompositeVector<
                                  ...
                                  vtkm::cont::ArrayHandle<vtkm::Float16>,
                                  vtkm::cont::ArrayHandle<vtkm::Float16>>::StorageTag>& input,
  vtkm::cont::DeviceAdapterId device = vtkm::cont::DeviceAdapterTagAny());
