...
int UnitTestBOVDataSetReader(int, char*[]);
int UnitTestPixelTypes(int, char*[]);
int UnitTestVTKDataSetReader(int, char*[]);
int UnitTestVTKDataSetWriter(int, char*[]);
int UnitTestImageWriter(int, char*[]);
...
static functionMapEntry cmakeGeneratedFunctionMapEntries[] = {
  ...
  {
    "UnitTestVTKDataSetReader",
    UnitTestVTKDataSetReader
  },
  {
    "UnitTestVTKDataSetWriter",
    UnitTestVTKDataSetWriter
  },
  {
    "UnitTestImageWriter",
