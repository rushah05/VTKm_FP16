...
set(VTKm_VERSION_FULL "1.5.0-1183-gd00071b4e")
...
set(VTKm_ENABLE_KOKKOS "")
set(VTKm_ENABLE_LOGGING "OFF")
...
if(CMAKE_CURRENT_LIST_DIR STREQUAL "/home/ruchi/fp16_vtkm_new/build/lib/cmake/vtkm-1.5")
  set(VTKm_PACKAGE_IN_BUILD TRUE)
endif()

if(VTKm_PACKAGE_IN_BUILD)
  set_and_check(VTKm_CMAKE_MODULE_PATH "/home/ruchi/fp16_vtkm_new/vtk-m/CMake")
else()
  set_and_check(VTKm_CMAKE_MODULE_PATH "${PACKAGE_PREFIX_DIR}/share/vtkm-1.5/cmake")
endif()

# Load the library exports, but only if not compiling VTK-m itself
set_and_check(VTKm_CONFIG_DIR "${PACKAGE_PREFIX_DIR}/lib/cmake/vtkm-1.5")
set(VTKM_FROM_INSTALL_DIR FALSE)
if(NOT "${CMAKE_BINARY_DIR}" STREQUAL "/home/ruchi/fp16_vtkm_new/build")
...
if(VTKm_ENABLE_CUDA AND VTKM_FROM_INSTALL_DIR)
  set_target_properties(vtkm::cuda PROPERTIES cuda_architecture_flags "--generate-code=arch=compute_70,code=sm_70")
